  ...
  $('#preloader').fadeOut('slow',function(){$(this).remove();});
   ...
   /******************* SLIDER 1 ************************/
    ...
    $('.slide-2').on('show',function(){
         ...
         $('.slide-2>.stickman_sl2>img').stop().css({'height':"0%", top: '217px'});
          ...
          setTimeout(function(){$('.slide-2 #focus_2').sprite({no_of_frames: 6, play_frames: 6})}, 1400);
    ...
    $('.slide-3').on('show',function(){
          ...
          setTimeout(function(){$('.slide-3 #focus_3').stop().stop().css({'display': "block"})}, 1700);  
          
          $('.slide-3 .arrow').stop().css({'opacity': "0"});
          
          setTimeout(function(){$('.slide-3 .arrow').stop().animate({'opacity': "1"}, 10)}, 1000); 
          setTimeout(function(){$('.slide-3 #arrow_sl3').sprite({no_of_frames: 7, play_frames: 7})}, 900);
          setTimeout(function(){$('.slide-3 #focus_3').sprite({no_of_frames: 7, play_frames: 7})}, 1400);
    ...
    $('.slide-4').on('show',function(){
          ...
          setTimeout(function(){$('#arrow_sl4').sprite({no_of_frames: 6, play_frames: 6})}, 900);
          setTimeout(function(){$('#focus_4').sprite({no_of_frames: 7, play_frames: 7})}, 1400);
   ...
   /******************** SLIDER 2 ************************/
    ...
    $('.slide-21').on('show',function(){
          ...
          $('.slide-21>.stickman_sl21>img').stop().css({'height':"0%", top: '217px'});
          $('.slide-21>.dialog_sl21').stop().css({'margin-top': "-500px"});
          ...
          setTimeout(function(){$('.slide-21 #arrow_sl2_1').sprite({no_of_frames: 11, play_frames: 11})}, 900);
          setTimeout(function(){$('.slide-21 #focus2_1').sprite({no_of_frames: 6, play_frames: 6})}, 1400);
      
        
          $( ".slide-21>.stickman_sl21>img" ).stop().delay(500).animate({height: "100%", top: "0"}, 950, 'easeOutElastic' );
          $( ".slide-21>.dialog_sl21" ).stop().delay(700).animate({marginTop: "0px"}, 550, 'easeOutExpo');
    ...
    $('.slide-22').on('show',function(){
          ...
          $('.slide-22>.stickman_sl22>img').stop().css({'height':"0%", top: '217px'});
          $('.slide-22>.dialog_sl22').stop().css({'margin-top': "-500px"});
          ...
          setTimeout(function(){$('.slide-22 #focus2_2').sprite({no_of_frames: 9, play_frames: 9})}, 1400);
      
        
          $( ".slide-22>.stickman_sl22>img" ).stop().delay(500).animate({height: "100%", top: "0"}, 950, 'easeOutElastic' );
          $( ".slide-22>.dialog_sl22" ).stop().delay(700).animate({marginTop: "0px"}, 550, 'easeOutExpo');
    ...
    $('.slide-23').on('show',function(){
        $('.slide-23>.stickman_sl23>img').stop().css({'height':"0%", top: '217px'});
          $('.slide-23>.dialog_sl23').stop().css({'margin-top': "-500px"});
          $('.slide-23 #arrow_sl2_3, .slide-23 #arrow_sl2_3 em').stop().css({'display': "none"});
          $('.slide-23 #focus2_3').stop().css({'display': "none"});
          
          setTimeout(function(){$('.slide-23 #arrow_sl2_3, .slide-23 #arrow_sl2_3 em').stop().css({'display': "block"})}, 1200);
          setTimeout(function(){$('.slide-23 #focus2_3').stop().css({'display': "block"})}, 1700);
        
          
          $('.slide-23 .arrow').stop().css({'opacity': "0"});
          
          setTimeout(function(){$('.slide-23 .arrow').stop().animate({'opacity': "1"}, 200)}, 900);   
          setTimeout(function(){$('.slide-23 #arrow_sl2_3').sprite({no_of_frames: 7, play_frames: 7})}, 900);
          setTimeout(function(){$('.slide-23 #focus2_3').sprite({no_of_frames: 5, play_frames: 5})}, 1400);
      
        
          $( ".slide-23>.stickman_sl23>img" ).stop().delay(500).animate({height: "100%", top: "0"}, 950, 'easeOutElastic' );
          $( ".slide-23>.dialog_sl23" ).stop().delay(700).animate({marginTop: "0px"}, 550, 'easeOutExpo');
    ...
    $('.slide-24').on('show',function(){
          ...
          $('.slide-24>.stickman_sl24>img').stop().css({'height':"0%", top: '217px'});
          $('.slide-24>.dialog_sl24').stop().css({'margin-top': "-500px"});
          $('.slide-24 #arrow_sl24, .slide-24 #arrow_sl24 em').stop().css({'display': "none"});
          $('.slide-24 #focus2_4').stop().css({'display': "none"});
          
          setTimeout(function(){$('.slide-24 #arrow_sl24, .slide-24 #arrow_sl24 em').stop().css({'display': "block"})}, 1200);
          setTimeout(function(){$('.slide-24 #focus2_4').stop().css({'display': "block"})}, 1700);     
          
          $('.slide-24 .arrow').stop().css({'opacity': "0"});
   
          setTimeout(function(){$('.slide-24 .arrow').stop().animate({'opacity': "1"}, 10)}, 1000);   
          setTimeout(function(){$('.slide-24 #arrow_sl24').sprite({no_of_frames: 8, play_frames: 8})}, 900);
          setTimeout(function(){$('.slide-24 #focus2_4').sprite({no_of_frames: 6, play_frames: 6})}, 1400);
      
        
          $( ".slide-24>.stickman_sl24>img" ).stop().delay(500).animate({height: "100%", top: "0"}, 950, 'easeOutElastic' );
          $( ".slide-24>.dialog_sl24" ).stop().delay(700).animate({marginTop: "0px"}, 550, 'easeOutExpo');
    ...
    $('.slide-25').on('show',function(){
          ...
          $('.slide-25>.stickman_sl25>img').stop().css({'height':"0%", top: '217px'});
          $('.slide-25>.dialog_sl25').stop().css({'margin-top': "-500px"});
          $('.slide-25 #arrow_sl2_5, .slide-25 #arrow_sl2_5 em').stop().css({'display': "none"});
          $('.slide-25 #focus2_5').stop().css({'display': "none"});
          
          setTimeout(function(){$('.slide-25 #arrow_sl2_5, .slide-25 #arrow_sl2_5 em').stop().css({'display': "block"})}, 1200);
          setTimeout(function(){$('.slide-25 #focus2_5').stop().css({'display': "block"})}, 1700);
        
          
          $('.slide-25 .arrow').stop().css({'opacity': "0"});
          
          setTimeout(function(){$('.slide-25 .arrow').stop().animate({'opacity': "1"}, 200)}, 900);   
          setTimeout(function(){$('.slide-25 #arrow_sl2_5').sprite({no_of_frames: 11, play_frames: 11})}, 900);
          setTimeout(function(){$('.slide-25 #focus2_5').sprite({no_of_frames: 8, play_frames: 8})}, 1400);
      
        
          $( ".slide-25>.stickman_sl25>img" ).stop().delay(500).animate({height: "100%", top: "0"}, 950, 'easeOutElastic' );
          $( ".slide-25>.dialog_sl25" ).stop().delay(700).animate({marginTop: "0px"}, 550, 'easeOutExpo');
    ...
    $('.slide-32').on('show',function(){
          ...
          $('.slide-32>.stickman_sl32>img').stop().css({'height':"0%", top: '217px'});
          $('.slide-32>.dialog_sl32').stop().css({'margin-top': "-500px"});
          $('.slide-32 #arrow_sl32, .slide-32 #arrow_sl32 em').stop().css({'display': "none"});
          $('.slide-32 #focus3_2').stop().css({'display': "none"});
          
          setTimeout(function(){$('.slide-32 #arrow_sl32, .slide-32 #arrow_sl32 em').stop().css({'display': "block"})}, 1200);
          setTimeout(function(){$('.slide-32 #focus3_2').stop().css({'display': "block"})}, 1700);     
          
          $('.slide-32 .arrow').stop().css({'opacity': "0"});
   
          setTimeout(function(){$('.slide-32 .arrow').stop().animate({'opacity': "1"}, 10)}, 1000);   
          setTimeout(function(){$('.slide-32 #arrow_sl32').sprite({no_of_frames: 8, play_frames: 8})}, 900);
          setTimeout(function(){$('.slide-32 #focus3_2').sprite({no_of_frames: 8, play_frames: 8})}, 1400);
      
        
          $( ".slide-32>.stickman_sl32>img" ).stop().delay(500).animate({height: "100%", top: "0"}, 950, 'easeOutElastic' );
          $( ".slide-32>.dialog_sl32" ).stop().delay(700).animate({marginTop: "0px"}, 550, 'easeOutExpo');
