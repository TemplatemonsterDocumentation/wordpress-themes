...
<article id="post-formats">
	...
	<article id="post_format_gallery">
		...
		<ol>
			<li>Click<strong> Add Media</strong>.
				<figure class="img-polaroid"><img src="img/wordpress/add_media.png" alt=""></figure></li>
	...
	<article id="post_format_image">
		...
		<p><strong>Image format </strong> is a format that includes one image uploaded through the <strong>Featured Image</strong> option.</p>
		<figure class="img-polaroid"><img src="img/wordpress/post_format_image.png" alt=""></figure>
		<p>Having selected this format, you can turn off the lightbox by uncheking the <strong>Enable Lightbox</strong> option.</p>
	</article>
	...
	<article id="post_format_video">
		...
		<ul>
			...
			<li><strong>Add alternative source for maximum HTML5 playback </strong> - alternative source of various video formats (mp4, ogv, webm)</li>
