<article id="components">
	...
	<ul>
		...
		<li><strong>flip X:</strong> - initial element angle flip at the beginning of animation (<strong>X-axis</strong> rotation min -360° max 360°)</li>
		<li><strong>flip Y:</strong> - initial element angle flip at the beginning of animation (<strong>Y-axis</strong> rotation min -360° max 360°)</li>
		...
		<li><strong>animation delay:</strong> - delay before next element appears (can be used in case you have two or more elements in a row and you want to animate them one by one)</li>
