<!-- Options Footer -->
			...
			<div class="row">
				<div class="grid_6">
					<figure class="img-polaroid">
						<a href="img/cherryframework/cherry-options_footer.jpg" class="pretty_image" rel="prettyPhoto[options]">
		...
		<article id="footer_logo">
			...
			<div class="row">
				<div class="grid_6">
					<figure class="img-polaroid">
						<a href="img/cherryframework/cherry-options_logo.jpg" class="pretty_image" rel="prettyPhoto[options]">
