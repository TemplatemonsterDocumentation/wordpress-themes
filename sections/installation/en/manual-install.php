<article id="manual-install">
	...
	<h5>Data Manager</h5>
	<ol>
		<li>Open WordPress admin panel and go to "<b>Tools > Cherry Import</b>" section
			<figure class="img-polaroid"><img src="img/cherryframework/sample_data_import_section.jpg" alt=""></figure>
		</li>
		<li>Open your downloaded template package and go to "<b>theme\sample_data\</b>" directory. All files from this directory should be uploaded to Cherry Import.</li>
		<li>You can select all files (CTRL+A) and drag them to the Cherry Import section or click "<b>Browse local files</b>" in Cherry Import. 
		...
		<li>Click "<b>Continue Install</b>" button to proceed.
			<figure class="img-polaroid"><img src="img/cherryframework/sample_data_import_install.jpg" alt=""></figure>
		</li>
		<li>When the installation process is done, you can view your website. It should be as at the live demo. </li>
	</ol>
